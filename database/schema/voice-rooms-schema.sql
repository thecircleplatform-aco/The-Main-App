-- Voice Rooms schema for Circle.
-- Audio-only LiveKit-powered rooms with speakers, listeners, and seat requests.
...
CREATE TABLE IF NOT EXISTS voice_rooms (
  ...
  -- Optional: unique room name used for LiveKit. If null, backend can derive from id.
